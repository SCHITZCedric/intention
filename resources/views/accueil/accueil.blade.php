...
<div class="row-md-6">
  ...
  <a href="{{url('/intentions')}}" type="button" class="btn btn-outline-primary btn-lg btn-block" data-toggle="data" title="En cliquant sur ce bouton, vous allez pouvoir modifier une intention">  <i class="fas fa-search"></i> Rechercher une intention</a>

  <a href="{{url('/ajouter-intention')}}" type="button" class="btn btn-outline-primary btn-lg btn-block" data-toggle="data" title="En cliquant sur ce bouton, vous allez pouvoir ajouter une nouvelle intention" >  <i class="fas fa-pencil-alt"></i>   Saisir une intention</a>
  ...
  <a href="{{ url('/statistiques') }}" type="button" class="btn btn-outline-primary btn-lg btn-block"  data-toggle="data" title="En cliquant sur ce bouton, vous allez obtenir des statistiques de votre paroisse"> <i class="fas fa-chart-pie"></i></i> Statistiques de votre paroisse</a>
