...
<form class="text-center border border-light p-5" action="{{ action ('RechercheController@filter')}}" method="POST">
@csrf
...
<div class="container">
    ...
    <div class="form-row mb-4">
        ...
        <!-- Sign up button -->
    <button class="btn btn-outline-primary my-4 btn-block" type="submit">Rechercher une intention</button>
