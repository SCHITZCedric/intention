          ...
          <div class="pull-left">
            <div class="input-group">
                <input class="form-control mr-sm-2" id="search"
                       ...
                       onkeydown="if (event.keyCode == 13) ajaxLoad('{{url('paroisses')}}?search='+this.value)"
                       placeholder="Rechercher un paroisse" name="search"
                       type="search"/>

                <div class="input-group-btn">
                    <button type="submit" class="btn btn-secondary"
                            onclick="ajaxLoad('{{url('paroisses')}}?search='+$('#search').val())">
