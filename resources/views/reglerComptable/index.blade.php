        ...
        @foreach ($reglers as $regler)
          <tr>
            ...
            <td>
                ...
                <a class="btn btn-primary" title="Regler" href="javascript:ajaxLoad('{{url('comptable/payer/'.$regler->id_celebrant)}}')">Régler une intention à {{$regler->nom}} {{$regler->prenom}}</a>
                </div>
            </td>
        </tr>
        @endforeach
